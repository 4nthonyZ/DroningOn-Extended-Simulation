...
// The main change is to change the method called from parcel to the method called from parcel manager
public class Location {
    ...
    public static void addObserver(Location.Observer observer) {
    ...
    public void setRoad(Suburb.Direction direction, Location location) {
    ...
    public Location getRoad(Suburb.Direction direction) {
